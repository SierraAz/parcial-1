...
INSERT INTO `clientes` VALUES (1,'Raul','55-5553-5','41875599'),(2,'jean paulo','555-459-899','41189700'),(3,'Carlos','4566-777-8999','3985258'),(11,'Steve','111-9879-566','44398700'),(13,'Alfonso','5656-898-666','45879899');
...
CREATE TABLE `pedidos` (
  ...
  `idtipopedidos` int NOT NULL,
  `fecha_realizacion` varchar(45) NOT NULL,
  PRIMARY KEY (`idpedidos`),
  KEY `idtipopedidos_idx` (`idtipopedidos`),
...
--
-- Table structure for table `tipopedidos`
--
...
CREATE TABLE `tipopedidos` (
  ...
  `trabajador_encargado` varchar(45) NOT NULL,
  PRIMARY KEY (`idtipopedidos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tipopedidos`
--
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `agregar_renta`(in IDMEMBRESIA int, in IDTIPOPEDIDOS int,in FECHAREA date)
BEGIN
insert into rentas(idmembresia,idtipopedidos,fecha_realizacion)
values(IDMEMBRESIA,IDTIPOPEDIDOS,FECHAREA);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
