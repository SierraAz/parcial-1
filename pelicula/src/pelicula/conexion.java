...
public class conexion extends javax.swing.JFrame {
        ...
        public void RellenaconsqlPelicula(String tabla, JTable visor)
    {
        ...
        model.addColumn("idtipopedidos");
        model.addColumn("tipopedido");
        model.addColumn("precio");
        model.addColumn("trabajador_encargado");
        ...
        public void ProcedimientoinsertPelicula(JTextField idtipopedidos, JTextField tipopedido, JTextField precio, JTextField trabajador_encargado)
    {
        try{
            ...
            proc.setString(1, idtipopedidos.getText());
            proc.setString(2, tipopedido.getText());
            proc.setString(3, precio.getText());
            proc.setString(4, trabajador_encargado.getText());

            proc.execute();
            
            JOptionPane.showMessageDialog(null, "Se ha añadido una nuevo tipo de pedido!");
        }catch(Exception e)
        {
